...
rs = np.load("Advanced/rsSaturn.npy")
R = np.load("Advanced/RSaturn.npy")
...
print("FPS = " + str(FPS))
print("No. light particles = " + str(rs.shape[1]))

len_sec = Rdown.shape[0] / FPS
len_min = np.floor(len_sec / 60)
print(
    "Video length = "
    + str(len_min)
    + " mins "
    + str(np.floor(len_sec - 60 * len_min))
    + " s"
)

print("Speed = " + str(downsample) + "x")
...
anim.save("Advanced/SaturnAdvanced.mp4", dpi=250)
